...
<body style="background-color: #04325b;">
    ...
    <div class="infoGeneral">
        <div class="contenidoCentral">
            ...
            <div class="detalles-Reservacion mb-5">
                <h4 class="subTitulos">Detalles de la Reservación</h4>
                <h6 id="espacioPago">Espacio:</h6>
                <h6 id="nombreUsuarioPago">Nombre:</h6>
                <h6 id="fechaPago">Fecha:</h6>
                <h6 id="horaPago">Hora:</h6>
            </div>
            ...
            <div class="mb-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-2">
                        <a class="boton-negativo" href="index.html">Cancelar</a>
                    </div>
                </div>
            </div>
